...
function ImgUpload() {
    return (
        <div className="flex flex-col items-center justify-center border border-gray-300 rounded-lg p-6 bg-gray-50">
            <h2 className="text-lg font-medium text-gray-800 mb-2">Enter Business Certifications</h2>
            <p className="text-sm text-gray-500 text-center mb-4">
                Upload your business certification to build trust, validate your authenticity, and showcase your credibility.
            </p>
            <div className="w-full max-w-xs flex flex-col items-center justify-center border-2 border-dashed border-gray-300 rounded-lg p-6 bg-white">
                <div className="text-gray-400 text-sm flex flex-col items-center cursor-pointer hover:text-gray-600">
                    ...
                    <span className="text-xs text-gray-500">PDF (max 1MB)</span>
                </div>
            </div>
        </div>
    );
